...
pub struct ChatMessage {
    ...
    pub content: String,
    /// Role that authored this message
...
pub struct ChatSession {
    ...
    pub id: Uuid,
    /// Ordered queue of all messages in this session
    pub messages: VecDeque<ChatMessage>,
    /// UTC timestamp when the session was created
    pub created_at: DateTime<Utc>,
    /// UTC timestamp of the most recent message added
...
impl ChatSession {
    ...
    /// Append a message to the session and update the `updated_at` timestamp
    pub fn add_message(&mut self, message: ChatMessage) {
        self.messages.push_back(message);
        self.updated_at = Utc::now();
    }

    /// Return up to `count` most-recent messages in chronological order
