...
pub enum ContentBlock {
    ...
    /// Tool result
    ToolResult {
        /// Identifier matching the originating tool use request.
        tool_use_id: String,
        /// Output produced by the tool.
        content: String,
        /// Exit code returned by the tool (0 = success).
        exit_code: i32,
    },
    /// Image content
    Image {
        /// Source reference for the image (URL, base64, or file path).
        source: String,
    },
}
...
impl SessionMetadata {
    /// Creates a new `SessionMetadata` with the given project path, model, tags, and extra data.
    pub fn new(
