...
impl FeatureSet {
    ...
    pub fn merge(&mut self, other: &FeatureSet) {
        ...
        self.constraints
            .mutually_exclusive
            .extend_from_slice(&other.constraints.mutually_exclusive);
        self.constraints
            .dependencies
            .extend(other.constraints.dependencies.clone());
        self.constraints
            .target_specific
            .extend(other.constraints.target_specific.clone());
        self.constraints
            .environment_specific
            .extend(other.constraints.environment_specific.clone());
    }
    ...
    pub fn terraphim_features() -> HashMap<String, String> {
        ...
        features.insert(
            ...
            "TypeScript bindings for WASM".to_string(),
        );
        features.insert(
            "native".to_string(),
            "Native platform optimizations".to_string(),
        );
        features.insert(
            "remote-loading".to_string(),
            "Remote resource loading".to_string(),
        );

        // AI features
        features.insert(
            "openrouter".to_string(),
            "OpenRouter AI integration".to_string(),
        );
        features.insert(
            "llm".to_string(),
            "Large Language Model support".to_string(),
        );
        ...
        features.insert(
            ...
            "Mock service implementations".to_string(),
        );
        ...
        features.insert(
            ...
            "Kubernetes integration".to_string(),
        );
        ...
        features.insert(
            ...
            "Cross-compilation support".to_string(),
        );
        ...
        features.insert(
            ...
            "Experimental functionality".to_string(),
        );
...
impl FeatureConstraints {
    ...
    pub fn terraphim_constraints() -> Self {
        ...
        constraints
            .dependencies
            .insert("kubernetes".to_string(), vec!["docker".to_string()]);
        constraints
            .dependencies
            .insert("test-utils".to_string(), vec!["dev-tools".to_string()]);
        ...
        constraints
            .target_specific
            .insert("wasm".to_string(), vec!["wasm32".to_string()]);
...
mod tests {
    ...
    fn test_feature_constraints() {
        let mut features = FeatureSet::new();
        features.constraints.mutually_exclusive =
            vec![vec!["debug-info".to_string(), "optimizations".to_string()]];
    ...
    fn test_feature_dependencies() {
        ...
        features
            .constraints
            .dependencies
            .insert("openrouter".to_string(), vec!["api".to_string()]);
