...
Third paragraph with more information.";
        ...
        let matched_term = Matched {
            ...
            normalized_term: NormalizedTerm::new("1".to_string(), NormalizedTermValue::from("database")),
    ...
    fn test_related_concepts_identification() {
        ...
        let matched_terms = vec![
            Matched {
                ...
                normalized_term: NormalizedTerm::new("1".to_string(), NormalizedTermValue::from("kubernetes")),
                pos: Some((0, 10)),
            },
            Matched {
                term: "database".to_string(),
                normalized_term: NormalizedTerm::new("2".to_string(), NormalizedTermValue::from("database")),
                pos: Some((20, 28)),
            },
        ];
