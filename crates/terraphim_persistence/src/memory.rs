...
mod tests {
    ...
    async fn test_thesaurus_memory_persistence() -> Result<()> {
        ...
        // Add some test terms
        let term1 = NormalizedTerm::new("1".to_string(), NormalizedTermValue::from("machine learning"));
        let term2 = NormalizedTerm::new("2".to_string(), NormalizedTermValue::from("artificial intelligence"));
