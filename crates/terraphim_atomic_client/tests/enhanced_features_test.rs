...
fn test_enhanced_commit_features() {
    ...
    properties.insert("https://atomicdata.dev/properties/name".to_string(), json!("Test Resource"));
    properties.insert("https://atomicdata.dev/properties/description".to_string(), json!("A test resource"));
    
    let commit = Commit::new_create_or_update(
    ...
    commit_copy.add_push("https://atomicdata.dev/properties/tags".to_string(), json!(["tag1", "tag2"]));
...
fn test_commit_builder_pattern() {
    ...
    let commit_result = CommitBuilder::new("http://localhost:9883/test".to_string())
        .set("https://atomicdata.dev/properties/name".to_string(), json!("Built Resource"))
        .set("https://atomicdata.dev/properties/description".to_string(), json!("Built with CommitBuilder"))
        .remove("https://atomicdata.dev/properties/old_field".to_string())
        .push("https://atomicdata.dev/properties/tags".to_string(), json!(["builder", "test"]))
    ...
    assert_eq!(commit.previous_commit.as_ref().unwrap(), "http://localhost:9883/commits/previous");
...
fn test_commit_validation() {
    ...
    let mut properties = HashMap::new();
    properties.insert("https://atomicdata.dev/properties/parent".to_string(), json!("http://localhost:9883/test"));
    ...
    valid_properties.insert("https://atomicdata.dev/properties/name".to_string(), json!("Valid Resource"));
...
fn test_atomic_haystack_compatibility() {
    ...
    let agent = Agent::new();
    let mut properties = HashMap::new();
    properties.insert("https://atomicdata.dev/properties/name".to_string(), json!("Test Document"));
...
fn test_agent_creation_methods() {
    ...
    let agent2 = Agent::new_with_name("Named Agent".to_string(), "http://localhost:9883".to_string());
...
fn test_commit_serialization() {
    ...
    let commit = CommitBuilder::new("http://localhost:9883/test".to_string())
        .set("https://atomicdata.dev/properties/name".to_string(), json!("Full Featured Resource"))
        .set("https://atomicdata.dev/properties/description".to_string(), json!("Has all features"))
        .remove("https://atomicdata.dev/properties/old_field".to_string())
        .push("https://atomicdata.dev/properties/tags".to_string(), json!(["tag1", "tag2"]))
        .set_previous_commit("http://localhost:9883/commits/previous".to_string())
        .build(&agent)
        .unwrap();
