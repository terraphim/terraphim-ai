 ...
 */
export function init_client(server_url, secret_b64) {
    const ptr0 = passStringToWasm0(server_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(secret_b64, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.init_client(ptr0, len0, ptr1, len1);
    return ret;
}
 ...
 * @returns {Promise<any>}
 */
export function delete_res() {
    const ret = wasm.delete_res();
    return ret;
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_closure_wrapper656 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 136, __wbg_adapter_46);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('atomic-wasm-demo_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
