...
async fn test_atomic_haystack_title_scorer_role() {
    ...
    let config = ConfigBuilder::new()
        ...
        .add_role("AtomicTitleScorer", {
            let mut role = Role::new("Atomic Title Scorer");
            role.shortname = Some("title-scorer".to_string());
            role.relevance_function = RelevanceFunction::TitleScorer;
            role.theme = "cerulean".to_string();
            role.haystacks = vec![Haystack::new(server_url.clone(), ServiceType::Atomic, true)
...
async fn test_atomic_haystack_graph_embeddings_role() {
    ...
    let config = ConfigBuilder::new()
        ...
        .add_role("AtomicGraphEmbeddings", {
            let mut role = Role::new("Atomic Graph Embeddings");
            role.shortname = Some("graph-embeddings".to_string());
            role.relevance_function = RelevanceFunction::TerraphimGraph;
            role.terraphim_it = true;
            role.theme = "superhero".to_string();
            role.kg = Some(terraphim_config::KnowledgeGraph {
...
async fn test_atomic_haystack_role_comparison() {
    ...
    let title_scorer_config = ConfigBuilder::new()
        .global_shortcut("Ctrl+T")
        .add_role("TitleScorer", {
            let mut role = Role::new("Title Scorer");
            role.shortname = Some("title-scorer".to_string());
            role.relevance_function = RelevanceFunction::TitleScorer;
            role.theme = "cerulean".to_string();
    ...
    let graph_embeddings_config = ConfigBuilder::new()
        .global_shortcut("Ctrl+G")
        .add_role("GraphEmbeddings", {
            let mut role = Role::new("Graph Embeddings");
            role.shortname = Some("graph-embeddings".to_string());
            role.relevance_function = RelevanceFunction::TerraphimGraph;
            role.terraphim_it = true;
            role.theme = "superhero".to_string();
...
async fn test_comprehensive_atomic_haystack_roles() {
    ...
    let pure_atomic_title_config = ConfigBuilder::new()
        ...
        .add_role("PureAtomicTitle", {
            let mut role = Role::new("Pure Atomic Title");
            role.shortname = Some("pure-atomic-title".to_string());
            role.relevance_function = RelevanceFunction::TitleScorer;
            role.theme = "cerulean".to_string();
            role.haystacks = vec![Haystack {
                location: server_url.clone(),
    ...
    let pure_atomic_graph_config = ConfigBuilder::new()
        ...
        .add_role("PureAtomicGraph", {
            let mut role = Role::new("Pure Atomic Graph");
            role.shortname = Some("pure-atomic-graph".to_string());
            role.relevance_function = RelevanceFunction::TerraphimGraph;
            role.terraphim_it = true;
            role.theme = "superhero".to_string();
            role.kg = Some(terraphim_config::KnowledgeGraph {
    ...
    let hybrid_title_config = ConfigBuilder::new()
        ...
        .add_role("HybridTitle", {
            let mut role = Role::new("Hybrid Title");
            role.shortname = Some("hybrid-title".to_string());
            role.relevance_function = RelevanceFunction::TitleScorer;
    ...
    let hybrid_graph_config = ConfigBuilder::new()
        ...
        .add_role("HybridGraph", {
            let mut role = Role::new("Hybrid Graph");
            role.shortname = Some("hybrid-graph".to_string());
            role.relevance_function = RelevanceFunction::TerraphimGraph;
            role.terraphim_it = true;
...
async fn test_atomic_haystack_error_handling() {
    ...
    let invalid_config = ConfigBuilder::new()
        ...
        .add_role("InvalidAtomic", {
            let mut role = Role::new("Invalid Atomic");
            role.shortname = Some("invalid-atomic".to_string());
            role.relevance_function = RelevanceFunction::TitleScorer;
            role.theme = "cerulean".to_string();
            role.haystacks = vec![Haystack {
    ...
    let no_secret_config = ConfigBuilder::new()
        ...
        .add_role("NoSecretAtomic", {
            let mut role = Role::new("No Secret Atomic");
            role.shortname = Some("no-secret-atomic".to_string());
            role.relevance_function = RelevanceFunction::TitleScorer;
            role.theme = "cerulean".to_string();
            role.haystacks = vec![Haystack {
                location: "http://localhost:9883".to_string(),
