...
mod paragraph_tests {
    ...
    fn extracts_paragraph_from_term() {
        ...
        let norm = NormalizedTerm::new("1".to_string(), NormalizedTermValue::from("lorem"));
...
mod replacement_bug_tests {
    ...
    fn test_empty_pattern_does_not_cause_spurious_insertions() {
        ...
        // Add a valid pattern
        let bun_nterm = NormalizedTerm::new("2".to_string(), NormalizedTermValue::from("bun"))
    ...
    fn test_single_char_pattern_is_filtered() {
        ...
        let single_char_nterm =
            NormalizedTerm::new("1".to_string(), NormalizedTermValue::from("expanded"))
    ...
    fn test_whitespace_only_pattern_is_filtered() {
        ...
        let ws_nterm = NormalizedTerm::new("1".to_string(), NormalizedTermValue::from("space"))
    ...
    fn test_valid_replacement_still_works() {
        ...
        // Valid patterns
        let bun_nterm = NormalizedTerm::new("1".to_string(), NormalizedTermValue::from("bun"))
            .with_display_value("bun".to_string());
        thesaurus.insert(NormalizedTermValue::from("npm"), bun_nterm);

        let yarn_nterm = NormalizedTerm::new("2".to_string(), NormalizedTermValue::from("bun"))
            .with_display_value("bun".to_string());
    ...
    fn test_find_matches_filters_empty_patterns() {
        ...
        // Empty pattern
        let empty_nterm = NormalizedTerm::new("1".to_string(), NormalizedTermValue::from("empty"))
            .with_display_value("empty".to_string());
        thesaurus.insert(NormalizedTermValue::from(""), empty_nterm);

        // Valid pattern
        let test_nterm = NormalizedTerm::new("2".to_string(), NormalizedTermValue::from("test"))
