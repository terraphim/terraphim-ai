...
"#;
    ...
    println!("✅ Haystack extraction result: {:?}", haystack_result.content);
    ...
    println!("✅ Graph embeddings extraction result: {:?}", graph_result.content);
    ...
    println!("✅ Multiple terms extraction result: {:?}", multiple_result.content);
...
async fn test_terms_connectivity_with_knowledge_graph() -> Result<()> {
    ...
    println!("✅ Synonym connectivity result: {:?}", synonym_connectivity.content);
    ...
    println!("✅ Graph embedding connectivity result: {:?}", graph_connectivity.content);
    ...
    println!("✅ Unconnected terms result: {:?}", unconnected_test.content);
    ...
    println!("✅ Single term connectivity result: {:?}", single_term.content);
    ...
    println!("✅ Mixed connectivity result: {:?}", mixed_connectivity.content);
...
"#;
    ...
    println!("✅ Haystack connectivity: {:?}", haystack_connectivity.content);
...
async fn test_advanced_automata_edge_cases() -> Result<()> {
    ...
    let long_text = "This is a test paragraph. ".repeat(100) + "The haystack provides excellent service.";
