...
async fn test_bug_report_extraction_with_kg_terms() -> Result<()> {
    ...
    println!(
        "✅ Impact analysis extraction: {:?}",
        impact_extraction.content
    );
    ...
    println!(
        "✅ Domain terminology connectivity: {:?}",
        domain_connectivity.content
    );
...
async fn test_bug_report_extraction_edge_cases() -> Result<()> {
    ...
    println!(
        "✅ Short content extraction: {:?}",
        short_extraction.content
    );
    ...
    println!(
        "✅ Overlapping terms extraction: {:?}",
        overlapping_extraction.content
    );
    ...
    println!(
        "✅ All terms connectivity check: {:?}",
        all_terms_connectivity.content
    );
