...
async fn test_mcp_server_uses_selected_role() -> Result<()> {
    ...
    println!(
        "✅ Configuration with selected role set: {:?}",
    ...
    println!(
        "✅ Build index result (selected role): {:?}",
    ...
    println!(
        "✅ Autocomplete result (selected role): {:?}",
        autocomplete_result.content
    );
    ...
    println!(
        "✅ Extract paragraphs result (selected role): {:?}",
    ...
    println!(
        "✅ Connectivity result (selected role): {:?}",
        connectivity_result.content
    );
    ...
    println!(
        "✅ Changed selected role to Default: {:?}",
        config_change_result.content
    );
    ...
    println!(
        "✅ Autocomplete with Default selected: {:?}",
        default_autocomplete.content
    );
...
async fn test_role_parameter_overrides_selected_role() -> Result<()> {
    ...
    println!(
        "✅ Explicit role result: {:?}",
        explicit_role_result.content
    );
    ...
    println!(
        "✅ Extract with explicit role: {:?}",
        extract_explicit.content
    );
