...
mod tests {
    ...
    fn test_web_pdf_command_parsing() {
        let result =
            terraphim_tui::repl::commands::ReplCommand::from_str("/web pdf https://example.com");
        assert!(result.is_ok());
    }
    ...
    fn test_web_status_command_parsing() {
        let result =
            terraphim_tui::repl::commands::ReplCommand::from_str("/web status webop-1642514400000");
        assert!(result.is_ok());
    }
    ...
    fn test_web_cancel_command_parsing() {
        let result =
            terraphim_tui::repl::commands::ReplCommand::from_str("/web cancel webop-1642514400000");
        assert!(result.is_ok());
    }

    #[test]
    fn test_web_history_command_parsing() {
        let result = terraphim_tui::repl::commands::ReplCommand::from_str("/web history");
        assert!(result.is_ok());
    }

    #[test]
    fn test_web_config_show_command_parsing() {
        let result = terraphim_tui::repl::commands::ReplCommand::from_str("/web config show");
        assert!(result.is_ok());
    }
    ...
    fn test_web_config_reset_command_parsing() {
        let result = terraphim_tui::repl::commands::ReplCommand::from_str("/web config reset");
        assert!(result.is_ok());
    }
    ...
    fn test_web_command_error_handling() {
        ...
        let result = terraphim_tui::repl::commands::ReplCommand::from_str("/web");
        assert!(result.is_err());

        // Test missing URL for GET
        let result = terraphim_tui::repl::commands::ReplCommand::from_str("/web get");
        assert!(result.is_err());

        // Test missing URL and body for POST
        let result =
            terraphim_tui::repl::commands::ReplCommand::from_str("/web post https://example.com");
        assert!(result.is_err());

        // Test missing operation ID for status
        let result = terraphim_tui::repl::commands::ReplCommand::from_str("/web status");
        assert!(result.is_err());

        // Test invalid subcommand
        let result = terraphim_tui::repl::commands::ReplCommand::from_str("/web invalid_command");
        assert!(result.is_err());
    }
    ...
    fn test_web_command_available_in_help() {
        ...
        let help_text = terraphim_tui::repl::commands::ReplCommand::get_command_help("web");
    ...
    fn test_all_web_subcommands_coverage() {
        ...
        for test_case in test_cases {
            ...
            match result.unwrap() {
                terraphim_tui::repl::commands::ReplCommand::Web { .. } => {
                    // Expected
                }
