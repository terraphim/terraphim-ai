...
/// State maintained for each active WebSocket client connection.
#[derive(Debug, Clone)]
...
/// Broadcast a progress update event for a running workflow.
...
/// Broadcast a completion or failure event when a workflow finishes.
...
/// Broadcast a start event when a workflow begins executing.
...
/// Return a health-check summary for the WebSocket server.
...
/// Return runtime statistics for all active WebSocket sessions.
