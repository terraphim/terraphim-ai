...
describe('ContextEditModal Integration Tests', () => {
  ...
  describe('Modal Rendering and UI', () => {
    it('should render edit modal with context data', () => {
      ...
      expect(screen.getByTestId('context-content-textarea')).toHaveValue('This is the full content of the test document with detailed information.');
  ...
  describe('Real API Integration', () => {
    it('should work with real context data from server', async () => {
      ...
      expect(screen.getByTestId('context-summary-textarea')).toHaveValue('This context was created via API for integration testing');
      expect(screen.getByTestId('context-content-textarea')).toHaveValue('Full content from API integration test');
    });
  });
