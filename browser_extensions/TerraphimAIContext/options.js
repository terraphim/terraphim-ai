/**
 * Options page JavaScript for TerraphimAIContext extension
 * Handles configuration UI and server communication
 */

class ContextOptionsPage {
    constructor() {
        this.api = window.terraphimContextAPI || new TerraphimContextAPI();
        this.elements = {};
        this.init();
    }
    ...
    bindElements() {
        this.elements = {
            ...
            atomicServerUrl: document.getElementById('atomicServerUrl'),
    ...
    async loadCurrentSettings() {
        try {
            ...
            if (stored.atomicServerUrl) {
                this.elements.atomicServerUrl.value = stored.atomicServerUrl;
            }
    ...
    async saveSettings() {
        ...
        try {
            const settings = {
                ...
                atomicServerUrl: this.elements.atomicServerUrl.value.trim()
            };
    ...
    async resetSettings() {
        if (confirm('Are you sure you want to reset all settings to defaults?')) {
            try {
                ...
                this.elements.atomicServerUrl.value = '';
